...
<div class="cart-container">
    <div class="page-breadcrumb background">
        <div class="uk-container uk-container-center">
            <ul class="uk-list uk-clearfix">
                ...
                @else
                <li><a title="Hệ thống phân phối">Giỏ hàng Order</a></li>
                @endif
            </ul>
        </div>
    </div>
    <div class="uk-container uk-container-center">
        ...
        <form action="{{ route('cart.store') }}" class="uk-form form" method="post">
            ...
            @else
            <h2 class="heading-1"><span>Giỏ hàng Order</span></h2>
            @endif
            <div class="cart-wrapper">
                <div class="panel-cart">
                    ...
                    @else
                    <button type="button" class="cart-checkout" onclick="window.location.href='{{ route('cart.checkout3', ['type' => 3]) }}'">
                        Thanh toán đơn hàng
                    </button>
                    @endif
