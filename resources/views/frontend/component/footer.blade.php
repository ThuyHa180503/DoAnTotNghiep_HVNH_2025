...
<footer class="footer">
                   ...
                   @endphp
                    ...
                    <div class="uk-width-large-1-4">
                        <div class="footer-contact">
                            ...
                            <p>
                                Số điện thoại: 
                                <a href="https://zalo.me/{{ $system['contact_hotline'] }}">
                                    {{ $system['contact_hotline'] }} (ZALO)
                                </a>
                            </p>
                            <p>Email: {{ $system['contact_email'] }}</p>
                            <p>Website: 
                                <a target="_blank" href="https://{{ $system['contact_website'] }}">
                                    {{ $system['contact_website'] }}
                                </a>
                            </p>
                        </div>
                    </div>
    ...
    <div class="copyright uk-text-center">
        © Copyright 2024, All Rights Reserved - Design by:  {{ $system['homepage_brand'] }} <br>
        Website demo chưa kinh doanh chính thức
    </div>
</footer>
        ...
        <div class="uk-width-2-4">
             <div class="fix-item">
                <a href="https://zalo.me/{{ $system['contact_hotline'] }}" class="btn btn-main" target="_blank">
                    ...
                    <div class="text">Liên hệ Zalo</div>
                </a>
            </div>
        </div>
