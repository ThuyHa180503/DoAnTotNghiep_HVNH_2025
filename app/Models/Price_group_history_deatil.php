...
class Price_group_history_deatil extends Model
{
    use HasFactory;
    protected $table = 'price_group_detail_history';
    ...
    {
        return $this->belongsTo(Price_group_history::class, 'price_group_id', 'id');
    }
